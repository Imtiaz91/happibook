...
namespace Happibook.API.Controller
{
    [CustomAuthorize]
    [RoutePrefix("City")]
    public class CityController : Controller<ICityService, CityDTO, City, int>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateCity(CityDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateCity(CityDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteCity(int id)
        {
