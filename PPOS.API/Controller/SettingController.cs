...
namespace Happibook.API.Controller
{
    [CustomAuthorize]
    [RoutePrefix("Setting")]
    public class SettingController : Controller<ISettingService, SettingDTO, Setting, int>
    {
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateCompany(SettingDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateCompany(SettingDTO dtoObject)
        {
        ...
        [HttpDelete]
        [Route("Delete")]
        public async Task<ResponseMessageResult> DeleteCompany(int id)
        {
