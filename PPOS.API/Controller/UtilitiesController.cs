...
namespace Happibook.API.Controller
{
    ...
    public class UtilitiesController : Controller<IUtilitiesService, UtilitiesDTO, Utilities, int>
    {
        public UtilitiesController(IUtilitiesService service)
            : base(service)
        {
        }
        ...
        [HttpPost]
        [Route("Create")]
        public async Task<ResponseMessageResult> CreateBed(UtilitiesDTO dtoObject)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<ResponseMessageResult> UpdateBed(UtilitiesDTO dtoObject)
        {
