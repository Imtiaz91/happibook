...
namespace Happibook.Core.Aspect
{
                ...
                if (auditOperation != null && !hasExecuted)
                {
                    if (input.Arguments != null)
                    {
                        ...
                        foreach (var argument in input.Arguments)
                        {
                            ...
                            {
                                if (argument != null && argument.ToString() != "Happibook.Common.Helper.JsonApiRequest")
                                {
                            ...
                            {
                                string message = null;
                                if (argument != null && argument.ToString() == "Happibook.Core.DTO.AuthDTO")
                                {
